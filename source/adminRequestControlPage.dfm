object controlRequestsForm: TcontrolRequestsForm
  ...
  object requestsTable: TStringGrid
    ...
    FixedCols = 0
    RowCount = 2
    Options = [goFixedVertLine, goFixedHorzLine, goVertLine, goHorzLine, goRangeSelect, goDrawFocusSelected, goColSizing, goRowSelect, goFixedRowDefAlign]
    TabOrder = 0
    OnClick = requestsTableClick
    OnDrawCell = requestsTableDrawCell
  end
